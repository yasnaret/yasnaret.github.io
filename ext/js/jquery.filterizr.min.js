    ...
    r.prototype = {
        ...
        setOptions: function (t) {
            ...
            if (e._mainArray && (t.animationDuration || t.delay || t.easing || t.delayMode))
                for (r = 0; r < e._mainArray.length; r++) e._mainArray[r].css("transition", "all " + e.options.animationDuration + "s " + e.options.easing + " " + e._mainArray[r]._calcDelay() + "ms");
        ...
        _makeSubarrays: function () {
            ...
            for (r = 0; r < t._mainArray.length; r++)
                if ("object" == typeof t._mainArray[r]._category)
                    for (var i in t._mainArray[r]._category) e[t._mainArray[r]._category[i] - 1].push(t._mainArray[r]);
        ...
        _calcItemPositions: function () {
            ...
            if ("horizontal" === t.options.layout)
                for (a = 1, c = 1; c <= i.length; c++) s = i[c - 1].outerWidth(), l = i[c - 1].outerHeight(), h.push({
                    left: f,
                    top: u
                }), f += s, l > n && (n = l);
